const dessertsGalleryContainer = document.getElementById(
...
function renderItems(list) {
  // dessertsGalleryContainer.innerHTML = "";
  list.forEach(({ image, name, category, price }) => {
    const itemContainer = document.createElement("div");
    itemContainer.classList.add("gallery-item-container");
    dessertsGalleryContainer.appendChild(itemContainer);
    itemContainer.innerHTML = `
                <div class="item-img-and-cart-btn">
